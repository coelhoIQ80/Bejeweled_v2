...
public class App extends Application {
    ...
    private Pane getGrid() {
        ...
        for (int n = 1; n <= 8; n++) {
            gridPane.getColumnConstraints().add(new ColumnConstraints(40)); // column 1 is 100 wide
            gridPane.getRowConstraints().add(new RowConstraints(40)); // column 1 is 100 wide
        }
    ...
    private void initBtnsArray() {
        ...
        for (int i = 0; i < btns.length; i++) {
            ...
            btns[i].setStyle("-fx-background-image: url('/testing/gem" + (myRandomNumber.nextInt(7) + 1) + ".png')");
